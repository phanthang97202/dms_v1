...
export const PageSize = ({ title, allowdPageSizes, showAllOption, showAllOptionText = 'Show All', onChangePageSize, defaultPageSize }: Props) => {
  let options = allowdPageSizes.map(item => ({ value: item, text: item + '' }));
  if (showAllOption) {
