...
export const handlers = [
    ...
    rest.get('/provinces', provinceHandler.getProvinces),
    rest.patch("/provinces\\(:id\\)", provinceHandler.updateProvince),
    rest.post("/provinces", provinceHandler.createProvince),
    rest.delete("/provinces\\(:id\\)", provinceHandler.deleteProvince),

    rest.get('/dealers', dealersHandler.getAllDealers),
    rest.patch("/dealers\\(:id\\)", dealersHandler.updateDealer),
    rest.post("/dealers", dealersHandler.createDealer),
    rest.delete("/dealers\\(:id\\)", dealersHandler.deleteDealer),
